...
from onmt.inputters.matrix_dataset import mat_sort_key, MatrixDataReader
from onmt.inputters.datareader_base import DataReaderBase


str2reader = {
    "text": TextDataReader, "img": ImageDataReader, "audio": AudioDataReader,
    "matrix": MatrixDataReader}
str2sortkey = {
...
__all__ = ['Dataset', 'load_old_vocab', 'get_fields', 'DataReaderBase',
           ...
           'text_sort_key', 'img_sort_key', 'audio_sort_key', 'mat_sort_key',
           'TextDataReader', 'ImageDataReader', 'AudioDataReader', 'MatrixDataReader']
